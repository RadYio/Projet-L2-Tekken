...
SOURCE = src/main.c src/initSdl.c src/deplacements.c src/menu_principal.c src/menu_selection.c src/animations.c src/personnages.c src/joueur.c src/son.c src/map.c src/gui.c src/menu.c src/pause.c
